...
EXCLUDED_FILES = {
    ...
    # r29 uses the hardened bootstrap_r27.py entrypoint for upgrade compatibility.
    # The upstream r26 file is retained only in this
    # working copy for audit/reference and must not confuse a clean installation.
