...
class Settings:
    ...
    def load(cls) -> "Settings":
        ...
        model = os.getenv("EIRVEN_MODEL", "gemma3:4b")
        return cls(
            root_dir=root,
            data_dir=data,
            ...
            model=model,
            fast_model=os.getenv("EIRVEN_FAST_MODEL", "gemma3:4b"),
            code_model=os.getenv("EIRVEN_CODE_MODEL", "gemma3:4b"),
            ...
            gigaam_model=os.getenv("EIRVEN_GIGAAM_MODEL", "gigaam-v3-e2e-rnnt").strip(),
