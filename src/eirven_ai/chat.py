...
class ChatService:
    ...
    def _messages(
        ...
        gender_rule = ("СТРОГО говори о себе только в женском роде: я сделала, открыла, нашла, готова, поняла, решила, проверила. Никогда не используй о себе мужские формы сделал/открыл/нашёл/готов/понял/решил/проверил." if assistant_gender == "female" else "СТРОГО говори о себе только в мужском роде: я сделал, открыл, нашёл, готов, понял, решил, проверил.")
